-- DROP FUNCTION public.layer_place(geometry, int4, numeric);

CREATE OR REPLACE FUNCTION public.layer_place(bbox geometry, zoom_level integer, pixel_width numeric)
 RETURNS TABLE(osm_id bigint, geometry geometry, name text, name_en text, name_de text, tags hstore, class text, rank integer, capital integer, iso_a2 text)
 LANGUAGE sql
